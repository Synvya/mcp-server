...
import { searchMenuItems, type ToolData } from '../dist/tool-handlers.js';
...
async function loadData() {
  ...
  try {
    ...
    dataLoaded = true;
    console.error("✅ Data loaded for search_menu_items:", {
...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  try {
    ...
    const result = searchMenuItems(args, toolData);
