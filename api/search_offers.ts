...
import { searchOffers, type ToolData } from '../dist/tool-handlers.js';
...
async function loadData() {
  try {
    ...
    console.log("✅ Data loaded for search_offers:", {
...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  try {
    ...
    if (params.offer_type) {
      args.offer_type = params.offer_type;
    }
    ...
    // Call handler
    const result = searchOffers(args, data);
